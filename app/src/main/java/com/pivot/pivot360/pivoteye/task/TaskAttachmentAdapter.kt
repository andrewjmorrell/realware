...
class TaskAttachmentAdapter(context1: FragmentActivity, attachments: MutableList<UserTaskQuery.Attachment1>?, myListener: OnItemClickListener) : RecyclerView.Adapter<TaskAttachmentAdapter.ViewHolder>() {
