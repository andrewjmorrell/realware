...
class EventsByAssetAdapter(context: FragmentActivity, events: ArrayList<EventsByAssetQuery.Event>, myListener: OnItemClickListener) : RecyclerView.Adapter<EventsByAssetAdapter.ViewHolder>() {
    private var listData: ArrayList<EventsByAssetQuery.Event> = events
